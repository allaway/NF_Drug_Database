...
write.table(ncats_join, "ncats_with_evotec_targets.txt", sep = "\t")
synStore(File("ncats_with_evotec_targets.txt", parentId = "syn8682571"), executed = this.file, used = c("syn8685814", "syn8314523", "syn8685703", "https://pubchem.ncbi.nlm.nih.gov/idexchange/idexchange.cgi"))
